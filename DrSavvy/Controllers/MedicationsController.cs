...
namespace DrSavvy.Controllers
{
    public class MedicationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Medication_ID,Mediction_Description")] Medication medication)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Medication_ID,Mediction_Description")] Medication medication)
        {
            if (ModelState.IsValid)
            {
